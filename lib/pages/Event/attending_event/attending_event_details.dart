...
class AttendingEvents extends StatefulWidget {
  const AttendingEvents({super.key});

  @override
  State<AttendingEvents> createState() => _AttendingEventsState();
}

class _AttendingEventsState extends State<AttendingEvents> {
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/tickets', arguments: event);
                  // showDialog(
                  //   context: context,
